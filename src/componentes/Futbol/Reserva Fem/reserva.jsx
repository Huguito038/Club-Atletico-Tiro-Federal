import stilo from "../Reserva Fem/reserva.module.css"
import tabla from "../Reserva Fem/Tabla.jpg"
import video from "../Reserva Fem/video.mp4"
    ...
    return (
        <div>
            <div className={stilo.contenedor_titulo}>
                <h2 className={stilo.titu}>RESERVA FEMENINA</h2>
